        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ $category->getRawOriginal('name') }} - Kategori Düzenle
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form action="{{ route('admin.categories.edit', $category->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="title">Kategori Adı</label>
                                    <input type="text" class="form-control" name="category_name" value="{{ old('category_name') ?: $category->getRawOriginal('name') }}">
                                </div>
                                <div class="form-group">
