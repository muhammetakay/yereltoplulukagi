...
@section('content')
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Etkinlik Düzenle</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="col-lg-6">
                            <form action="{{ route('admin.events.edit', $event->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="event_name" value="{{ old('event_name') ?: $event->name }}">
                                </div>
                                <div class="form-group">
                                    <label for="event_date">Etkinlik Tarihi</label>
                                    <input type="datetime-local" class="form-control" name="event_date" value="{{ old('event_date') ?: $event->event_date->format('Y-m-d\TH:i') }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" id="description" rows="5">{{ old('description') ?: $event->description }}</textarea>
                                </div>
                                <div class="form-group">
